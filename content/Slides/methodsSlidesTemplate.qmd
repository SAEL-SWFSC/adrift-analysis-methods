...
format: 
  revealjs:
    slide-number: true
    footer: "[Return to methods](https://sael-swfsc.github.io/adrift-analysis-methods)" #This should link to your methods page
    theme: black
editor: visual
---
...
Edit the author and link in the footer above to redirect to your main methods page
...
![](images/download.jpg){fig-align="left" width="194"}
:::
:::
