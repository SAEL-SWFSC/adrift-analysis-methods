...
All drifts used a default Pamguard settings file. To view the Pamguard settings files used for each drift please click here (insert link to GitHub repository). Open default Pamguard settings file and save each drift under a new .psfx as ADRIFT\_###\_PGversion_Minke (ADRIFT_001_PG_2\_02_02_Minke.psfx)
