...
-   PAMGuard version 2.02.02 was used to run a GPL detector to look for Minke whale boings. All detections were manually scanned to annotate boings, then 20% of all of the data was subsampled to verify boings were not being missed.
