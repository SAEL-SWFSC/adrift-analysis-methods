...
## Click Detector Settings (Fin 20Hz only)
...
![Figure x. Source information for the click detector](Screenshots/Fin_Click_detector_Source_Settings.jpg)

![Figure X. Trigger settings for the Click Detector](Screenshots/Fin_Click_detector_Trigger_Settings.jpg)

![Figure X. Click length settings for the click detector ](Screenshots/Fin_Click_detector_Click_Length_Settings.jpg)

![Figure x. Delays settings for the click detector](Screenshots/Fin_Click_detector_Delays_Settings.jpg)

![Figure x. Echo settings for the click detector](Screenshots/Fin_Click_detector_Echo_Settings.jpg)

![Figure x. Noise settings for the click detector](Screenshots/Fin_Click_detector_Noise_Settings.jpg)

### Filter Settings

#### Digital Pre Filter Settings

![Figure x. Digital Pre Filter Settings](Screenshots/Fin_Click_Digital_PreFilter_Settings.jpg)

#### Digital Trigger Filter Settings

![Figure x. Digital Trigger Filter Settings](Screenshots/Fin_Click_Digital_Trigger_Filter_Settings.jpg)
...
![Figure x. Click classification general settings](Screenshots/Fin_Click_Classifcation_Settings.jpg)

![Figure x. Click classifier settings](Screenshots/Fin_Click_Click_Classifier_Settings.jpg)
