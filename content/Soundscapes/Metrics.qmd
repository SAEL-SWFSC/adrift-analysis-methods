...
![Example of a broadband ship in the 1 hr LTSA (top) and 10 s spectrogram (bottom).](images/Ship_Broadband.png){#Ship_Broadband width="1408"}

![Example of a narrowband/low frequency ship in the 1 hr LTSA (top; red box) and 10 s spectrogram (bottom).](images/Ship_narrowband.PNG){#Ship_Narrowband}
