...
## Spectrogram Annotation & Detection Grouper Settings
...
## Add Spectrogram Annotation Module
...
ADD METHODS FOR BOXING BOINGS

# Additional 20% Data Validation

## 20% Validation Code

-   Due to the nature of this large data set we decided to use a stratified sub-sampling method to randomly sample 20% of all events for additional validation.
