...
format: 
  revealjs:
    slide-number: true
    footer: "[Source Code](https://github.com/SAEL-SWFSC/adrift-analysis-methods/content/BaleenWhales/BlueWhales/BlueWhales-ManualDetection/BlueWhaleLoggingSlides.qmd)" #This should link to your methods page
    theme: black
editor: visual
---
...
![](/content/Slides/images/TritonSetupComplete.png){fig-align="center"}
