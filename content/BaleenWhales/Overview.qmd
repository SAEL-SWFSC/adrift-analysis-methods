...
-   [PAMGuard](https://www.pamguard.org/) software was used to automatically detect fin whale 20Hz pulses in the ADRIFT dataset.
...
-   PAMpal was used to create events in each database

    -   Events were defined as every wav file

    -   Wav file lengths and duty cycles varied depending on deployment but all information related to deployment details can be found [here](https://docs.google.com/spreadsheets/d/10bxlwfVOe1LFfj69B_YddxcA0V14m7codYwgD2YncFk/edit#gid=1736197089).
...
-   The model was then tested on novel data

-   The model was then used to predict on the rest of the fin whale events for all drifts

### *Review of Model Results*

-   The model had one of three results: Accept, Review, Dropped

-   If the model had \>3 predictions and a high average score, the event was accepted as a fin whale

-   If the model had \>3 predictions and a low average score, the event was thrown into a review column
