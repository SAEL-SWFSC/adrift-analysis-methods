...
-   [PAMpal](https://taikisan21.github.io/PAMpal/) was used to create events in each database
...
-   More detail of these methods can be found [here](https://github.com/SAEL-SWFSC/adrift-analysis-methods/blob/main/content/BaleenWhales/Slides/20HzFinMethods.html)
